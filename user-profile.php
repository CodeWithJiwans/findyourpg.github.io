...
<?php } ?>
						...
						<div class="form-group">
								<input type="text" class="form-control" id="alternetnumber" name="alternetnumber" placeholder="Alternet Number" maxlength="10" pattern="[0-9]+" value="<?php  echo $row['AlternetNumber'];?>">
							</div>	
						</div>
						<?php } ?>
